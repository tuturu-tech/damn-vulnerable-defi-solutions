...
describe("[Challenge] Climber", function () {
	...
	it("Exploit", async function () {
		...
		const BadVault = await ethers.getContractFactory("BadVault", attacker);
		const badVault = await BadVault.deploy();

		const ATTACKER = await ethers.getContractFactory("AttackClimber", attacker);
